...
const Header = () => {
  ...
  const linker = (
    <>
      ...
      <Link to={`/${activeLanguage}/stake`} className="hover:text-indigo-color text-lg font-semibold  text-gray-600">
        <div>{t('Stake')}</div>
      </Link>
      ...
      <Link
        to={`/${activeLanguage}/dashboard`}
        className="hover:text-indigo-color text-lg font-semibold  text-gray-600 capitalize"
      >
        <div>{t('dashboard')}</div>
      </Link>
    </>
